...
<br>
``Normal`` requires input of an 2D array of at least 3 vertices. Additionally, it may ``autoflip`` away from the origin, which may be supplied as X1, Y1, Z1, shown above, or assumed to be 0,0,0 if these are omitted.<br>
example:
```js
var facet = [
  [-1, 0, 0],
